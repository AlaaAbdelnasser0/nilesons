...
$.fn.mycaptcha = function(options)
{
	...
	{
		$(this).find(opt.navHolder).html('<div id="next-swa" style="padding-top: 3px;" class="swa-nav btn">'+opt.nextText+'</div><div id="prev-swa" style="padding-top: 3px;" class="swa-nav btn">'+opt.prevText+'</div>');
