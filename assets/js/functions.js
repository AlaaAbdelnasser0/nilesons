...
(function($) {
		...
		var ThemeBuilder = function(){
				...
				/* Page Scroll To Counters ============ */
				var pageScrollToCounters = function (){
					/* page scroll Counters on click function */	
					jQuery("div.READ-MORE").on('click',function() { 
						jQuery('html').animate({ scrollTop: 807 }, 500);
						return false;
					});
